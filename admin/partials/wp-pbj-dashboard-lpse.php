...
<script src="<?php echo PBJ_PLUGIN_URL; ?>public/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- ChartJS -->
<script src="<?php echo PBJ_PLUGIN_URL; ?>public/plugins/chart.js/Chart.min.js"></script>
<!-- AdminLTE App -->
